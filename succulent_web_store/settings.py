"""
Django settings for succulent_web_store project.
...
SECRET_KEY = 'hu(6(nn#zfv=r4(ntg0flu4dx3*6o*p^**j6kn!emx__#+d-4)'
...
ROOT_URLCONF = 'succulent_web_store.urls'
...
WSGI_APPLICATION = 'succulent_web_store.wsgi.application'
